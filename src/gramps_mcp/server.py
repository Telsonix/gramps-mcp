...
TOOL_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "find_type": {
        "description": (
            ...
            "CRITICAL GQL SYNTAX - Array properties REQUIRE index [0] or array operators: "
            "- Surname (CORRECT): primary_name.surname_list[0].surname = \"Smith\" "
            "- First name: primary_name.first_name ~ \"John\" "
            "- Any surname in list: primary_name.surname_list.any.surname ~ \"Smith\" "
            "- All surnames have prefix: primary_name.surname_list.all.prefix "
            ...
            "REMEMBER: List properties like surname_list, event_ref_list need [0] or .any or .all. "
